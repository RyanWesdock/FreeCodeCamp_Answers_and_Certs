def largest_product_in_a_series(n, li):
    largest_product = 0
    for i in range(0, len(li) - (n - 1)):
        contender_product = 1
        for j in range(0, n):
            if li[i + j] != 0:
                contender_product *= li[i + j]
            else:
                break
        if contender_product > largest_product:
            largest_product = contender_product
    return largest_product


num_li = [7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9, 2, 2, 5, 1, 1, 9, 6, 7, 4, 4, 2, 6, 5, 7, 4, 7, 4,
...
print(largest_product_in_a_series(13, num_li))
